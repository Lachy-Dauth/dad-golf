...
> Shipped. Group activity feed with likes/comments, privacy controls, 7 event
> types (round completed, round started, scheduled round, member joined,
> handicap change, competition won, badge earned).
