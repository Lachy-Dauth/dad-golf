...
> public), 7 event types (round completions, new members, scheduled rounds,
> competition wins, handicap changes, badges earned). Simple reverse-chronological
> feed — no algorithmic ranking.
