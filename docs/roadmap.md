...
**Remaining: ~5.5 weeks** (Skins Game, Shareable Cards, PDF Scorecards). Some can run in parallel.
...
**Remaining: ~8 weeks** (Recurring Leagues, Scoring Formats). Parallel tracks possible.
...
**Shipped (17):** 8c Dark Mode, 8d PWA Install, 9b Weather, 5c CTP/Longest Drive, 6c Group Roles, 7c Handicap Auto-Adj, 1c Round Replay, 3a Community Courses, 2c Scheduled Rounds, 9a Calendar Integration, 4a Activity Feed, 4c Achievement Badges, 1a Stats Dashboard, 6b Group Stats, 1b Head-to-Head (plus location autocomplete and course reviews).
