...
**Phase total: ~5.5 weeks remaining** (Skins, Shareable Cards, PDF Scorecards)
...
**Phase total: ~7-9 weeks remaining** (Leagues, Scoring Formats; parallel tracks possible)
...
The longest dependency chain of remaining features:
...
The Stats Dashboard → Head-to-Head chain is complete.
Remaining features (Phases 4-6) could ship over approximately
**4-5 months** at part-time pace.
