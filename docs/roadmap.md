...
**Remaining: ~5.5 weeks** (Skins, Shareable Cards, PDF Scorecards — can run in parallel)
...
```
Stats Dashboard (3w) → Head-to-Head (2w)        ← both shipped ✅
Recurring Leagues (5w) → League Awards (2w)      ← longest remaining
Scoring Formats (4w) → Team Rounds (3w)
```

**Longest remaining chain: Leagues → Awards = ~7 weeks**
...
| ------------------- | -------------- | ------------- |
| Shipped             | 15 features ✅ | ~0 weeks      |
| Remaining           | 7 features     | ~17 weeks     |
| **Total remaining** | **7 features** | **~17 weeks** |

**Shipped so far:** 1a Stats Dashboard, 1b Head-to-Head, 1c Round Replay, 2c Scheduled Rounds, 3a Community Courses, 4a Activity Feed, 4c Achievement Badges, 5c CTP/Longest Drive, 6b Group Stats, 6c Group Roles, 7c Handicap Auto-Adj, 8c Dark Mode, 8d PWA Install, 9a Calendar Integration, 9b Weather (plus location autocomplete, course reviews, security hardening, and WHS daily handicap).

**Remaining:** 5a Skins Game, 4b Shareable Cards, 8e PDF Scorecards, 2a Recurring Leagues, 7a Scoring Formats, 2b League Awards, 7b Team Rounds.
