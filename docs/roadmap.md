...
**Phase total: ~5.5 weeks remaining** (Stats Dashboard and Group Stats shipped; some can run in parallel)
...
**Phase total: ~7-9 weeks remaining** (Head-to-Head shipped; parallel tracks possible)
...
The remaining features (Phases 4-6 unshipped items) could ship over
approximately **4-5 months** at part-time pace.
...
| Remaining           | 7 features     | ~15.5 weeks     |
| **Total remaining** | **7 features** | **~15.5 weeks** |
